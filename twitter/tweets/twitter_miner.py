...
## usage:   collect tweets based on subjects in a csv file 
...
##      nltk package 
##      numpy
##      input/twitter_subjects.csv file 
...
twitter_subjects      = np.genfromtxt('input/twitter_subjects.csv', skip_header=False, delimiter=',', dtype='|S')
